...
# Load files
DC01_15<-read.delim("../04_transcriptomica/DC01_15_sw10L50.genesorder.txt", header= FALSE)
DC02_15<-read.delim("../04_transcriptomica/DC02_15_sw10L50.genesorder.txt", header= FALSE)
DC03_15<-read.delim("../04_transcriptomica/DC03_15_sw10L50.genesorder.txt", header= FALSE)
DC04_15<-read.delim("../04_transcriptomica/DC04_15_sw10L50.genesorder.txt", header= FALSE)
DC05_15<-read.delim("../04_transcriptomica/DC05_15_sw10L50.genesorder.txt", header= FALSE)

DS01_15<-read.delim("../04_transcriptomica/DS01_15_sw10L50.genesorder.txt", header= FALSE)
DS02_15<-read.delim("../04_transcriptomica/DS02_15_sw10L50.genesorder.txt", header= FALSE)
DS04_15<-read.delim("../04_transcriptomica/DS04_15_sw10L50.genesorder.txt", header= FALSE)

HC01_15<-read.delim("../04_transcriptomica/SC01_15_sw10L50.genesorder.txt", header= FALSE)
HC02_15<-read.delim("../04_transcriptomica/SC02_15_sw10L50.genesorder.txt", header= FALSE)
HC03_15<-read.delim("../04_transcriptomica/SC03_15_sw10L50.genesorder.txt", header= FALSE)
HC04_15<-read.delim("../04_transcriptomica/SC04_15_sw10L50.genesorder.txt", header= FALSE)
HC05_15<-read.delim("../04_transcriptomica/SC05_15_sw10L50.genesorder.txt", header= FALSE)

HS01_15<-read.delim("../04_transcriptomica/SS01_15_sw10L50.genesorder.txt", header= FALSE)
HS02_15<-read.delim("../04_transcriptomica/SS02_15_sw10L50.genesorder.txt", header= FALSE)
HS05_15<-read.delim("../04_transcriptomica/SS05_15_sw10L50.genesorder.txt", header= FALSE)

HC01_17<-read.delim("../04_transcriptomica/SC01_17_sw10L50.genesorder.txt", header= FALSE)
DC04_17<-read.delim("../04_transcriptomica/DC04_17_sw10L50.genesorder.txt", header= FALSE)
